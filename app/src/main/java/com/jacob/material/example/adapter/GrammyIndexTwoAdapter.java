...
public class GrammyIndexTwoAdapter extends BaseQuickAdapter<Grammy, BaseViewHolder> {
    private RecyclerView recyclerView;
    private float itemCountPerContainer;
    private float itemSpace;


    public GrammyIndexTwoAdapter(List<Grammy> data, float itemCountPerContainer, float itemSpace) {
        super(R.layout.grammy_index_item_two_holder, data);
