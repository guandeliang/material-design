...
class InsetsAnimationLinearLayout @JvmOverloads constructor(
    ...
    override fun onNestedPreScroll(target: View, dx: Int, dy: Int, consumed: IntArray, type: Int) {
        ...
        if (deltaY < 0) {
            ...
            } else if (scrollImeOffScreenWhenVisible && !imeAnimController.isInsetAnimationRequestPending() && rootWindowInsets.isVisible(WindowInsets.Type.ime())) {
    ...
    override fun onNestedScroll(target: View, dxConsumed: Int, dyConsumed: Int, dxUnconsumed: Int, dyUnconsumed: Int, type: Int, consumed: IntArray) {
        if (dyUnconsumed > 0) {
            ...
            } else if (scrollImeOnScreenWhenNotVisible && !imeAnimController.isInsetAnimationRequestPending() && !rootWindowInsets.isVisible(WindowInsets.Type.ime())) {
