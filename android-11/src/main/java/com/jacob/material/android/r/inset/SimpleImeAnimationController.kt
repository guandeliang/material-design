...
internal class SimpleImeAnimationController {
    ...
    private val animationControlListener: WindowInsetsAnimationControlListener by lazy {
        object : WindowInsetsAnimationControlListener {
             ...
             */
            override fun onReady(controller: WindowInsetsAnimationController, types: Int) = onRequestReady(controller)
     ...
     */
    fun startControlRequest(view: View, onRequestReady: ((WindowInsetsAnimationController) -> Unit)? = null) {
